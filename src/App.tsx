...
export default function App() {
  return (
    <div id="app-container" className="h-screen flex bg-[#F8FAFC] font-sans text-[#334155] overflow-hidden">
      <aside id="sidebar" className="w-56 bg-[#1E293B] flex flex-col shrink-0 text-slate-400">
        <div id="logo-container" className="p-5 flex items-center gap-3 border-b border-slate-700/50">
      ...
      <main id="main-content" className="flex-1 flex flex-col h-screen overflow-hidden bg-[#F8FAFC]">
        <header id="main-header" className="h-14 bg-white border-b border-slate-200 flex items-center px-6 justify-between shrink-0">
          <h1 className="text-sm font-semibold text-slate-800">Vue d'ensemble</h1>
          <div id="header-tools" className="flex items-center gap-4">
            <div className="relative">
              <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400" size={14} />
              <input type="text" placeholder="Rechercher..." className="bg-slate-100 border-none rounded-full py-1.5 pl-8 pr-4 text-xs w-64 focus:ring-2 focus:ring-blue-500 outline-none" />
            </div>
        ...
        <div id="content-grid" className="p-6 space-y-6 overflow-y-auto">
